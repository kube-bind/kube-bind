...
import (
	...
	"github.com/kube-bind/kube-bind/contrib/example-backend-kcp/controllers/clusterbinding"
	"github.com/kube-bind/kube-bind/contrib/example-backend-kcp/controllers/serviceexport"
	"github.com/kube-bind/kube-bind/contrib/example-backend-kcp/controllers/serviceexportrequest"
	"github.com/kube-bind/kube-bind/contrib/example-backend-kcp/controllers/servicenamespace"
