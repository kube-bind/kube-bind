...
import (
	...
	"github.com/kube-bind/kube-bind/contrib/example-backend-kcp/cookie"
	"github.com/kube-bind/kube-bind/contrib/example-backend-kcp/kubernetes"
	"github.com/kube-bind/kube-bind/contrib/example-backend-kcp/kubernetes/resources"
	"github.com/kube-bind/kube-bind/contrib/example-backend-kcp/template"
