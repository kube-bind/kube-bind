...
var (
	...
	KubeBindRootClusterName = logicalcluster.NewPath("root:kube-bind")
)
...
func Bootstrap(
	...
	kcpClient := kcpClientSet.Cluster(KubeBindRootClusterName)
	...
	return bindAPIExport(ctx, kcpClient, "kube-bind.io", KubeBindRootClusterName)
}
