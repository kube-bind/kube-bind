...
type ServiceBindingSession struct {
	...
	Status ServiceBindingSessionStatus `json:"status,omitempty"`
}
...
// ServiceBindingSessionList is a list of ServiceBindingSessions.
//
// +k8s:deepcopy-gen:interfaces=k8s.io/apimachinery/pkg/runtime.Object
type ServiceBindingSessionList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata"`

	Items []ServiceBindingSession `json:"items"`
}
