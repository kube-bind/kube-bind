...
func (in *APIServiceExportTemplateSpec) DeepCopyInto(out *APIServiceExportTemplateSpec) {
	*out = *in
	...
	if in.ClaimedResources != nil {
		in, out := &in.ClaimedResources, &out.ClaimedResources
		*out = make([]PermissionClaim, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClaimVerbs) DeepCopyInto(out *ClaimVerbs) {
	*out = *in
	if in.Provider != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClaimVerbs.
func (in *ClaimVerbs) DeepCopy() *ClaimVerbs {
	if in == nil {
		return nil
	}
	out := new(ClaimVerbs)
