...
func (in *APIServiceExportSpec) DeepCopyInto(out *APIServiceExportSpec) {
	*out = *in
	...
	if in.PermissionClaims != nil {
		in, out := &in.PermissionClaims, &out.PermissionClaims
		*out = make([]ExportPermissionClaim, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExportPermissionClaim) DeepCopyInto(out *ExportPermissionClaim) {
	*out = *in
	in.PermissionClaim.DeepCopyInto(&out.PermissionClaim)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExportPermissionClaim.
func (in *ExportPermissionClaim) DeepCopy() *ExportPermissionClaim {
	if in == nil {
		return nil
	}
	out := new(ExportPermissionClaim)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PermissionClaimReadOptions) DeepCopyInto(out *PermissionClaimReadOptions) {
	*out = *in
	...
	if in.AnnotationsOnProviderOwnedObjects != nil {
		in, out := &in.AnnotationsOnProviderOwnedObjects, &out.AnnotationsOnProviderOwnedObjects
		*out = make([]Matcher, len(*in))
		copy(*out, *in)
	}
	return
