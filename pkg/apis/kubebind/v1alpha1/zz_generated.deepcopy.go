...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReadOptions) DeepCopyInto(out *ReadOptions) {
	*out = *in
	if in.Labels != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReadOptions.
func (in *ReadOptions) DeepCopy() *ReadOptions {
	if in == nil {
		return nil
	}
	out := new(ReadOptions)
