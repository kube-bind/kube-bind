...
func (c *aPIServiceExportRequests) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.APIServiceExportRequest, err error) {
	result = &v1alpha1.APIServiceExportRequest{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *aPIServiceExportRequests) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.APIServiceExportRequestList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.APIServiceExportRequestList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("apiserviceexportrequests").
...
func (c *aPIServiceExportRequests) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *aPIServiceExportRequests) Create(ctx context.Context, aPIServiceExportRequest *v1alpha1.APIServiceExportRequest, opts v1.CreateOptions) (result *v1alpha1.APIServiceExportRequest, err error) {
	result = &v1alpha1.APIServiceExportRequest{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("apiserviceexportrequests").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(aPIServiceExportRequest).
		Do(ctx).
		Into(result)
	return
}
...
func (c *aPIServiceExportRequests) Update(ctx context.Context, aPIServiceExportRequest *v1alpha1.APIServiceExportRequest, opts v1.UpdateOptions) (result *v1alpha1.APIServiceExportRequest, err error) {
	result = &v1alpha1.APIServiceExportRequest{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apiserviceexportrequests").
...
func (c *aPIServiceExportRequests) UpdateStatus(ctx context.Context, aPIServiceExportRequest *v1alpha1.APIServiceExportRequest, opts v1.UpdateOptions) (result *v1alpha1.APIServiceExportRequest, err error) {
	result = &v1alpha1.APIServiceExportRequest{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apiserviceexportrequests").
...
func (c *aPIServiceExportRequests) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *aPIServiceExportRequests) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *aPIServiceExportRequests) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.APIServiceExportRequest, err error) {
	result = &v1alpha1.APIServiceExportRequest{}
