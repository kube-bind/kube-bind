...
func (c *clusterBindings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ClusterBinding, err error) {
	result = &v1alpha1.ClusterBinding{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *clusterBindings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ClusterBindingList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ClusterBindingList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("clusterbindings").
...
func (c *clusterBindings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *clusterBindings) Create(ctx context.Context, clusterBinding *v1alpha1.ClusterBinding, opts v1.CreateOptions) (result *v1alpha1.ClusterBinding, err error) {
	result = &v1alpha1.ClusterBinding{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("clusterbindings").
...
func (c *clusterBindings) Update(ctx context.Context, clusterBinding *v1alpha1.ClusterBinding, opts v1.UpdateOptions) (result *v1alpha1.ClusterBinding, err error) {
	result = &v1alpha1.ClusterBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("clusterbindings").
...
func (c *clusterBindings) UpdateStatus(ctx context.Context, clusterBinding *v1alpha1.ClusterBinding, opts v1.UpdateOptions) (result *v1alpha1.ClusterBinding, err error) {
	result = &v1alpha1.ClusterBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("clusterbindings").
...
func (c *clusterBindings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *clusterBindings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *clusterBindings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ClusterBinding, err error) {
	result = &v1alpha1.ClusterBinding{}
