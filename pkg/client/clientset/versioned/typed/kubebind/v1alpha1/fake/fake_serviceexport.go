...
var serviceexportsResource = schema.GroupVersionResource{Group: "kube-bind.io", Version: "v1alpha1", Resource: "serviceexports"}

var serviceexportsKind = schema.GroupVersionKind{Group: "kube-bind.io", Version: "v1alpha1", Kind: "ServiceExport"}
