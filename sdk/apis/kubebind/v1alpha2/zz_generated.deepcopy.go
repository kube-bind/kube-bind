...
func (in *APIServiceBindingStatus) DeepCopyInto(out *APIServiceBindingStatus) {
	*out = *in
	...
	if in.BoundResources != nil {
		...
		*out = make([]BoundResourceReference, len(*in))
		copy(*out, *in)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BoundResourceReference) DeepCopyInto(out *BoundResourceReference) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BoundResourceReference.
func (in *BoundResourceReference) DeepCopy() *BoundResourceReference {
	if in == nil {
		return nil
	}
	out := new(BoundResourceReference)
	in.DeepCopyInto(out)
	return out
}
