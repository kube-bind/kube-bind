...
// CatalogV1alpha1Client is used to interact with features provided by the catalog.kube-bind.io group.
type CatalogV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CatalogV1alpha1Client) Collections(namespace string) CollectionInterface {
	return newCollections(c, namespace)
}

func (c *CatalogV1alpha1Client) Modules(namespace string) ModuleInterface {
