...
type aPIServiceBindings struct {
	*gentype.ClientWithList[*v1alpha1.APIServiceBinding, *v1alpha1.APIServiceBindingList]
}
...
func newAPIServiceBindings(c *KubeBindV1alpha1Client) *aPIServiceBindings {
	return &aPIServiceBindings{
		gentype.NewClientWithList[*v1alpha1.APIServiceBinding, *v1alpha1.APIServiceBindingList](
			"apiservicebindings",
			c.RESTClient(),
