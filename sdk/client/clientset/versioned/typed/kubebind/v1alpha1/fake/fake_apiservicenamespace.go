...
type fakeAPIServiceNamespaces struct {
	*gentype.FakeClientWithList[*v1alpha1.APIServiceNamespace, *v1alpha1.APIServiceNamespaceList]
	Fake *FakeKubeBindV1alpha1
}

func newFakeAPIServiceNamespaces(fake *FakeKubeBindV1alpha1, namespace string) kubebindv1alpha1.APIServiceNamespaceInterface {
	return &fakeAPIServiceNamespaces{
		gentype.NewFakeClientWithList[*v1alpha1.APIServiceNamespace, *v1alpha1.APIServiceNamespaceList](
			fake.Fake,
			namespace,
