...
var apiconversionsResource = v1alpha2.SchemeGroupVersion.WithResource("apiconversions")

var apiconversionsKind = v1alpha2.SchemeGroupVersion.WithKind("APIConversion")

// Get takes name of the aPIConversion, and returns the corresponding aPIConversion object, and an error if there is any.
func (c *FakeAPIConversions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha2.APIConversion, err error) {
	emptyResult := &v1alpha2.APIConversion{}
	obj, err := c.Fake.
		Invokes(testing.NewRootGetActionWithOptions(apiconversionsResource, name, options), emptyResult)
	if obj == nil {
		return emptyResult, err
	}
	return obj.(*v1alpha2.APIConversion), err
}

// List takes label and field selectors, and returns the list of APIConversions that match those selectors.
func (c *FakeAPIConversions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha2.APIConversionList, err error) {
	emptyResult := &v1alpha2.APIConversionList{}
	obj, err := c.Fake.
	...
	list := &v1alpha2.APIConversionList{ListMeta: obj.(*v1alpha2.APIConversionList).ListMeta}
	for _, item := range obj.(*v1alpha2.APIConversionList).Items {
...
func (c *FakeAPIConversions) Create(ctx context.Context, aPIConversion *v1alpha2.APIConversion, opts v1.CreateOptions) (result *v1alpha2.APIConversion, err error) {
	emptyResult := &v1alpha2.APIConversion{}
	obj, err := c.Fake.
...
func (c *FakeAPIConversions) Update(ctx context.Context, aPIConversion *v1alpha2.APIConversion, opts v1.UpdateOptions) (result *v1alpha2.APIConversion, err error) {
	emptyResult := &v1alpha2.APIConversion{}
	obj, err := c.Fake.
...
func (c *FakeAPIConversions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteActionWithOptions(apiconversionsResource, name, opts), &v1alpha2.APIConversion{})
	return err
}
...
func (c *FakeAPIConversions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1alpha2.APIConversionList{})
	return err
}

// Patch applies the patch and returns the patched aPIConversion.
func (c *FakeAPIConversions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.APIConversion, err error) {
	emptyResult := &v1alpha2.APIConversion{}
	obj, err := c.Fake.
