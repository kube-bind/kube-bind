...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	switch resource {
	// Group=catalog.kube-bind.io, Version=v1alpha1
	case v1alpha1.SchemeGroupVersion.WithResource("collections"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Catalog().V1alpha1().Collections().Informer()}, nil
	case v1alpha1.SchemeGroupVersion.WithResource("modules"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Catalog().V1alpha1().Modules().Informer()}, nil
