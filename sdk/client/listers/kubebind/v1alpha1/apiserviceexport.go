...
type aPIServiceExportLister struct {
	listers.ResourceIndexer[*kubebindv1alpha1.APIServiceExport]
}
...
func NewAPIServiceExportLister(indexer cache.Indexer) APIServiceExportLister {
	return &aPIServiceExportLister{listers.New[*kubebindv1alpha1.APIServiceExport](indexer, kubebindv1alpha1.Resource("apiserviceexport"))}
}

// APIServiceExports returns an object that can list and get APIServiceExports.
func (s *aPIServiceExportLister) APIServiceExports(namespace string) APIServiceExportNamespaceLister {
	return aPIServiceExportNamespaceLister{listers.NewNamespaced[*kubebindv1alpha1.APIServiceExport](s.ResourceIndexer, namespace)}
}
