...
type aPIServiceExportRequestLister struct {
	listers.ResourceIndexer[*kubebindv1alpha2.APIServiceExportRequest]
}
...
func NewAPIServiceExportRequestLister(indexer cache.Indexer) APIServiceExportRequestLister {
	return &aPIServiceExportRequestLister{listers.New[*kubebindv1alpha2.APIServiceExportRequest](indexer, kubebindv1alpha2.Resource("apiserviceexportrequest"))}
}

// APIServiceExportRequests returns an object that can list and get APIServiceExportRequests.
func (s *aPIServiceExportRequestLister) APIServiceExportRequests(namespace string) APIServiceExportRequestNamespaceLister {
	return aPIServiceExportRequestNamespaceLister{listers.NewNamespaced[*kubebindv1alpha2.APIServiceExportRequest](s.ResourceIndexer, namespace)}
}
