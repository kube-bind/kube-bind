...
type APIServiceExportRequestStatusApplyConfiguration struct {
	Phase           *kubebindv1alpha1.APIServiceExportRequestPhase `json:"phase,omitempty"`
...
func (b *APIServiceExportRequestStatusApplyConfiguration) WithPhase(value kubebindv1alpha1.APIServiceExportRequestPhase) *APIServiceExportRequestStatusApplyConfiguration {
	b.Phase = &value
	return b
}
