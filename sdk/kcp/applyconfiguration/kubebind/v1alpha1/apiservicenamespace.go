...
type APIServiceNamespaceApplyConfiguration struct {
	...
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	Spec                             *v1alpha1.APIServiceNamespaceSpec            `json:"spec,omitempty"`
...
func (b *APIServiceNamespaceApplyConfiguration) WithSpec(value v1alpha1.APIServiceNamespaceSpec) *APIServiceNamespaceApplyConfiguration {
	b.Spec = &value
	return b
}
