...
type APIServiceNamespaceApplyConfiguration struct {
	...
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	Spec                             *kubebindv1alpha2.APIServiceNamespaceSpec    `json:"spec,omitempty"`
...
func (b *APIServiceNamespaceApplyConfiguration) WithSpec(value kubebindv1alpha2.APIServiceNamespaceSpec) *APIServiceNamespaceApplyConfiguration {
	b.Spec = &value
	return b
}
