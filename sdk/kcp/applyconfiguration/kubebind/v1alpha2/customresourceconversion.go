...
type CustomResourceConversionApplyConfiguration struct {
	Strategy *kubebindv1alpha2.ConversionStrategyType `json:"strategy,omitempty"`
...
func (b *CustomResourceConversionApplyConfiguration) WithStrategy(value kubebindv1alpha2.ConversionStrategyType) *CustomResourceConversionApplyConfiguration {
	b.Strategy = &value
	return b
}
