...
type APIServiceExportRequestClusterInterface interface {
	...
	List(ctx context.Context, opts metav1.ListOptions) (*kubebindv1alpha1.APIServiceExportRequestList, error)
...
func (c *aPIServiceExportRequestsClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*kubebindv1alpha1.APIServiceExportRequestList, error) {
...
// APIServiceExportRequestsNamespacer can scope to objects within a namespace, returning a kubebindv1alpha1client.APIServiceExportRequestInterface.
type APIServiceExportRequestsNamespacer interface {
	Namespace(string) kubebindv1alpha1client.APIServiceExportRequestInterface
}
