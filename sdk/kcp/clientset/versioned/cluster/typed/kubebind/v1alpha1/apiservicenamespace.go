...
type APIServiceNamespaceClusterInterface interface {
	...
	List(ctx context.Context, opts metav1.ListOptions) (*kubebindv1alpha1.APIServiceNamespaceList, error)
...
func (c *aPIServiceNamespacesClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*kubebindv1alpha1.APIServiceNamespaceList, error) {
...
// APIServiceNamespacesNamespacer can scope to objects within a namespace, returning a kubebindv1alpha1client.APIServiceNamespaceInterface.
type APIServiceNamespacesNamespacer interface {
	Namespace(string) kubebindv1alpha1client.APIServiceNamespaceInterface
}
