...
import (
	...
	applyconfiguration "github.com/kube-bind/kube-bind/sdk/kcp/applyconfiguration"
	clientset "github.com/kube-bind/kube-bind/sdk/kcp/clientset/versioned"
	kcpclientset "github.com/kube-bind/kube-bind/sdk/kcp/clientset/versioned"
	kcpclientscheme "github.com/kube-bind/kube-bind/sdk/kcp/clientset/versioned/scheme"
	...
	kcpfakekubebindv1alpha1 "github.com/kube-bind/kube-bind/sdk/kcp/clientset/versioned/typed/kubebind/v1alpha1/fake"
	kcpkubebindv1alpha2 "github.com/kube-bind/kube-bind/sdk/kcp/clientset/versioned/typed/kubebind/v1alpha2"
	kubebindv1alpha2 "github.com/kube-bind/kube-bind/sdk/kcp/clientset/versioned/typed/kubebind/v1alpha2"
	kcpfakekubebindv1alpha2 "github.com/kube-bind/kube-bind/sdk/kcp/clientset/versioned/typed/kubebind/v1alpha2/fake"
)
...
func (c *ClusterClientset) KubeBindV1alpha1() kcpkubebindv1alpha1.KubeBindV1alpha1ClusterInterface {
	return &kcpfakekubebindv1alpha1.KubeBindV1alpha1ClusterClient{Fake: &c.Fake}
}
...
func (c *ClusterClientset) KubeBindV1alpha2() kcpkubebindv1alpha2.KubeBindV1alpha2ClusterInterface {
	return &kcpfakekubebindv1alpha2.KubeBindV1alpha2ClusterClient{Fake: &c.Fake}
}
...
func (c *Clientset) KubeBindV1alpha1() kubebindv1alpha1.KubeBindV1alpha1Interface {
	return &kcpfakekubebindv1alpha1.KubeBindV1alpha1Client{Fake: c.Fake, ClusterPath: c.clusterPath}
}
...
func (c *Clientset) KubeBindV1alpha2() kubebindv1alpha2.KubeBindV1alpha2Interface {
	return &kcpfakekubebindv1alpha2.KubeBindV1alpha2Client{Fake: c.Fake, ClusterPath: c.clusterPath}
}
