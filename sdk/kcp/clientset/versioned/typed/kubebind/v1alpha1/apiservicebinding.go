...
// or scope down to one cluster and return a APIServiceBindingInterface.
type APIServiceBindingClusterInterface interface {
	Cluster(logicalcluster.Path) APIServiceBindingInterface
	List(ctx context.Context, opts v1.ListOptions) (*kubebindv1alpha1.APIServiceBindingList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	APIServiceBindingClusterExpansion
}
...
func (c *aPIServiceBindingsClusterInterface) Cluster(clusterPath logicalcluster.Path) APIServiceBindingInterface {
...
func (c *aPIServiceBindingsClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*kubebindv1alpha1.APIServiceBindingList, error) {
...
func (c *aPIServiceBindingsClusterInterface) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
