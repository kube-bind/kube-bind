...
type APIServiceExportInterface interface {
	...
	Apply(ctx context.Context, aPIServiceExport *applyconfigurationkubebindv1alpha1.APIServiceExportApplyConfiguration, opts v1.ApplyOptions) (result *kubebindv1alpha1.APIServiceExport, err error)
	// Add a +genclient:noStatus comment above the type to avoid generating ApplyStatus().
	ApplyStatus(ctx context.Context, aPIServiceExport *applyconfigurationkubebindv1alpha1.APIServiceExportApplyConfiguration, opts v1.ApplyOptions) (result *kubebindv1alpha1.APIServiceExport, err error)
	APIServiceExportExpansion
}

// aPIServiceExports implements APIServiceExportInterface
type aPIServiceExports struct {
	*gentype.ClientWithListAndApply[*kubebindv1alpha1.APIServiceExport, *kubebindv1alpha1.APIServiceExportList, *applyconfigurationkubebindv1alpha1.APIServiceExportApplyConfiguration]
}
...
func newAPIServiceExports(c *KubeBindV1alpha1Client, namespace string) *aPIServiceExports {
	return &aPIServiceExports{
		gentype.NewClientWithListAndApply[*kubebindv1alpha1.APIServiceExport, *kubebindv1alpha1.APIServiceExportList, *applyconfigurationkubebindv1alpha1.APIServiceExportApplyConfiguration](
			"apiserviceexports",
			c.RESTClient(),
