...
type APIServiceNamespaceInterface interface {
	...
	Apply(ctx context.Context, aPIServiceNamespace *applyconfigurationkubebindv1alpha1.APIServiceNamespaceApplyConfiguration, opts v1.ApplyOptions) (result *kubebindv1alpha1.APIServiceNamespace, err error)
	// Add a +genclient:noStatus comment above the type to avoid generating ApplyStatus().
	ApplyStatus(ctx context.Context, aPIServiceNamespace *applyconfigurationkubebindv1alpha1.APIServiceNamespaceApplyConfiguration, opts v1.ApplyOptions) (result *kubebindv1alpha1.APIServiceNamespace, err error)
	APIServiceNamespaceExpansion
}

// aPIServiceNamespaces implements APIServiceNamespaceInterface
type aPIServiceNamespaces struct {
	*gentype.ClientWithListAndApply[*kubebindv1alpha1.APIServiceNamespace, *kubebindv1alpha1.APIServiceNamespaceList, *applyconfigurationkubebindv1alpha1.APIServiceNamespaceApplyConfiguration]
}
...
func newAPIServiceNamespaces(c *KubeBindV1alpha1Client, namespace string) *aPIServiceNamespaces {
	return &aPIServiceNamespaces{
		gentype.NewClientWithListAndApply[*kubebindv1alpha1.APIServiceNamespace, *kubebindv1alpha1.APIServiceNamespaceList, *applyconfigurationkubebindv1alpha1.APIServiceNamespaceApplyConfiguration](
