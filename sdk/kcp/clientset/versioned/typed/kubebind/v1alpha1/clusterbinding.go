...
type ClusterBindingInterface interface {
	...
	Apply(ctx context.Context, clusterBinding *applyconfigurationkubebindv1alpha1.ClusterBindingApplyConfiguration, opts v1.ApplyOptions) (result *kubebindv1alpha1.ClusterBinding, err error)
	// Add a +genclient:noStatus comment above the type to avoid generating ApplyStatus().
	ApplyStatus(ctx context.Context, clusterBinding *applyconfigurationkubebindv1alpha1.ClusterBindingApplyConfiguration, opts v1.ApplyOptions) (result *kubebindv1alpha1.ClusterBinding, err error)
	ClusterBindingExpansion
}

// clusterBindings implements ClusterBindingInterface
type clusterBindings struct {
	*gentype.ClientWithListAndApply[*kubebindv1alpha1.ClusterBinding, *kubebindv1alpha1.ClusterBindingList, *applyconfigurationkubebindv1alpha1.ClusterBindingApplyConfiguration]
}
...
func newClusterBindings(c *KubeBindV1alpha1Client, namespace string) *clusterBindings {
	return &clusterBindings{
		gentype.NewClientWithListAndApply[*kubebindv1alpha1.ClusterBinding, *kubebindv1alpha1.ClusterBindingList, *applyconfigurationkubebindv1alpha1.ClusterBindingApplyConfiguration](
			"clusterbindings",
			c.RESTClient(),
