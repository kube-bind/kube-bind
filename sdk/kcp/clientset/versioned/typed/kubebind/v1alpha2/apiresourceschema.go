...
// or scope down to one cluster and return a APIResourceSchemaInterface.
type APIResourceSchemaClusterInterface interface {
	Cluster(logicalcluster.Path) APIResourceSchemaInterface
	List(ctx context.Context, opts v1.ListOptions) (*kubebindv1alpha2.APIResourceSchemaList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	APIResourceSchemaClusterExpansion
}
...
func (c *aPIResourceSchemasClusterInterface) Cluster(clusterPath logicalcluster.Path) APIResourceSchemaInterface {
...
func (c *aPIResourceSchemasClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*kubebindv1alpha2.APIResourceSchemaList, error) {
...
func (c *aPIResourceSchemasClusterInterface) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
