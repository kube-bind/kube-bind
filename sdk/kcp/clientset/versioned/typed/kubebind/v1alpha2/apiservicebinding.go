...
type APIServiceBindingInterface interface {
	...
	Apply(ctx context.Context, aPIServiceBinding *applyconfigurationkubebindv1alpha2.APIServiceBindingApplyConfiguration, opts v1.ApplyOptions) (result *kubebindv1alpha2.APIServiceBinding, err error)
	// Add a +genclient:noStatus comment above the type to avoid generating ApplyStatus().
	ApplyStatus(ctx context.Context, aPIServiceBinding *applyconfigurationkubebindv1alpha2.APIServiceBindingApplyConfiguration, opts v1.ApplyOptions) (result *kubebindv1alpha2.APIServiceBinding, err error)
	APIServiceBindingExpansion
}

// aPIServiceBindings implements APIServiceBindingInterface
type aPIServiceBindings struct {
	*gentype.ClientWithListAndApply[*kubebindv1alpha2.APIServiceBinding, *kubebindv1alpha2.APIServiceBindingList, *applyconfigurationkubebindv1alpha2.APIServiceBindingApplyConfiguration]
}
...
func newAPIServiceBindings(c *KubeBindV1alpha2Client) *aPIServiceBindings {
	return &aPIServiceBindings{
		gentype.NewClientWithListAndApply[*kubebindv1alpha2.APIServiceBinding, *kubebindv1alpha2.APIServiceBindingList, *applyconfigurationkubebindv1alpha2.APIServiceBindingApplyConfiguration](
			"apiservicebindings",
			c.RESTClient(),
