...
type APIServiceExportRequestInterface interface {
	...
	Apply(ctx context.Context, aPIServiceExportRequest *applyconfigurationkubebindv1alpha2.APIServiceExportRequestApplyConfiguration, opts v1.ApplyOptions) (result *kubebindv1alpha2.APIServiceExportRequest, err error)
	// Add a +genclient:noStatus comment above the type to avoid generating ApplyStatus().
	ApplyStatus(ctx context.Context, aPIServiceExportRequest *applyconfigurationkubebindv1alpha2.APIServiceExportRequestApplyConfiguration, opts v1.ApplyOptions) (result *kubebindv1alpha2.APIServiceExportRequest, err error)
...
type aPIServiceExportRequests struct {
	*gentype.ClientWithListAndApply[*kubebindv1alpha2.APIServiceExportRequest, *kubebindv1alpha2.APIServiceExportRequestList, *applyconfigurationkubebindv1alpha2.APIServiceExportRequestApplyConfiguration]
}
...
func newAPIServiceExportRequests(c *KubeBindV1alpha2Client, namespace string) *aPIServiceExportRequests {
	return &aPIServiceExportRequests{
		gentype.NewClientWithListAndApply[*kubebindv1alpha2.APIServiceExportRequest, *kubebindv1alpha2.APIServiceExportRequestList, *applyconfigurationkubebindv1alpha2.APIServiceExportRequestApplyConfiguration](
