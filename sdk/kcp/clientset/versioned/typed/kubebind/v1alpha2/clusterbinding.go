...
type ClusterBindingClusterInterface interface {
	...
	ClusterBindingClusterExpansion
}
...
func (c *clusterBindingsClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*kubebindv1alpha2.ClusterBindingList, error) {
...
func (c *clusterBindingsClusterInterface) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.clientCache.ClusterOrDie(logicalcluster.Wildcard).ClusterBindings(v1.NamespaceAll).Watch(ctx, opts)
}

// ClusterBindingsNamespacer can scope to objects within a namespace, returning a ClusterBindingInterface.
type ClusterBindingsNamespacer interface {
	Namespace(string) ClusterBindingInterface
}
...
func (n *clusterBindingsNamespacer) Namespace(namespace string) ClusterBindingInterface {
