...
import (
	...
	kubebind "github.com/kube-bind/kube-bind/sdk/kcp/informers/externalversions/kubebind"
)
...
type SharedInformerFactory interface {
	...
	KubeBind() kubebind.ClusterInterface
}

func (f *sharedInformerFactory) KubeBind() kubebind.ClusterInterface {
	return kubebind.New(f, f.tweakListOptions)
}
...
func NewSharedScopedInformerFactory(client versioned.Interface, defaultResync time.Duration, namespace string) SharedScopedInformerFactory {
...
func NewSharedScopedInformerFactoryWithOptions(client versioned.Interface, defaultResync time.Duration, options ...SharedInformerOption) SharedScopedInformerFactory {
...
func (f *sharedScopedInformerFactory) KubeBind() kubebind.Interface {
	return kubebind.NewScoped(f, f.namespace, f.tweakListOptions)
}
