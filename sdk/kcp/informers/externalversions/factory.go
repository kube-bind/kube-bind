...
import (
	...
	kubebindinformers "github.com/kube-bind/kube-bind/sdk/kcp/informers/externalversions/kubebind"
)
...
type SharedInformerFactory interface {
	...
	KubeBind() kubebindinformers.ClusterInterface
}

func (f *sharedInformerFactory) KubeBind() kubebindinformers.ClusterInterface {
	return kubebindinformers.New(f, f.tweakListOptions)
}
...
type SharedScopedInformerFactory interface {
	...
	KubeBind() kubebindinformers.Interface
}

func (f *sharedScopedInformerFactory) KubeBind() kubebindinformers.Interface {
	return kubebindinformers.NewScoped(f, f.namespace, f.tweakListOptions)
}
