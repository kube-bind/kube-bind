...
// NewScopedInformerFunc takes versioned.Interface and time.Duration to return a SharedIndexInformer.
type NewScopedInformerFunc func(versioned.Interface, time.Duration) cache.SharedIndexInformer
