...
type APIServiceExportRequestClusterInformer interface {
	...
	Lister() kubebindv1alpha1.APIServiceExportRequestClusterLister
}
	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubeBindV1alpha1().APIServiceExportRequests().List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubeBindV1alpha1().APIServiceExportRequests().Watch(context.Background(), options)
			},
		},
		&apiskubebindv1alpha1.APIServiceExportRequest{},
		resyncPeriod,
		indexers,
	)
}
...
func (i *aPIServiceExportRequestClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apiskubebindv1alpha1.APIServiceExportRequest{}, i.defaultInformer)
}

func (i *aPIServiceExportRequestClusterInformer) Lister() kubebindv1alpha1.APIServiceExportRequestClusterLister {
	return kubebindv1alpha1.NewAPIServiceExportRequestClusterLister(i.Informer().GetIndexer())
}
...
type aPIServiceExportRequestInformer struct {
	...
	lister   kubebindv1alpha1.APIServiceExportRequestLister
}
...
func (i *aPIServiceExportRequestInformer) Lister() kubebindv1alpha1.APIServiceExportRequestLister {
	return i.lister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubeBindV1alpha1().APIServiceExportRequests(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubeBindV1alpha1().APIServiceExportRequests(namespace).Watch(context.Background(), options)
			},
		},
		&apiskubebindv1alpha1.APIServiceExportRequest{},
		resyncPeriod,
...
func (i *aPIServiceExportRequestScopedInformer) Lister() kubebindv1alpha1.APIServiceExportRequestLister {
	return kubebindv1alpha1.NewAPIServiceExportRequestLister(i.Informer().GetIndexer())
}
