...
type APIServiceExportRequestClusterInformer interface {
	...
	Lister() kubebindv1alpha1listers.APIServiceExportRequestClusterLister
}
	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.KubeBindV1alpha1().APIServiceExportRequests().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubeBindV1alpha1().APIServiceExportRequests().Watch(context.TODO(), options)
			},
		},
...
func (f *aPIServiceExportRequestClusterInformer) Lister() kubebindv1alpha1listers.APIServiceExportRequestClusterLister {
	return kubebindv1alpha1listers.NewAPIServiceExportRequestClusterLister(f.Informer().GetIndexer())
}
...
func (f *aPIServiceExportRequestInformer) Lister() kubebindv1alpha1listers.APIServiceExportRequestLister {
	return f.lister
}
...
func (f *aPIServiceExportRequestScopedInformer) Lister() kubebindv1alpha1listers.APIServiceExportRequestLister {
	return kubebindv1alpha1listers.NewAPIServiceExportRequestLister(f.Informer().GetIndexer())
}
