...
type APIServiceNamespaceClusterInformer interface {
	...
	Lister() kubebindv1alpha1.APIServiceNamespaceClusterLister
}
	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubeBindV1alpha1().APIServiceNamespaces().List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubeBindV1alpha1().APIServiceNamespaces().Watch(context.Background(), options)
			},
		},
...
func (i *aPIServiceNamespaceClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apiskubebindv1alpha1.APIServiceNamespace{}, i.defaultInformer)
}

func (i *aPIServiceNamespaceClusterInformer) Lister() kubebindv1alpha1.APIServiceNamespaceClusterLister {
	return kubebindv1alpha1.NewAPIServiceNamespaceClusterLister(i.Informer().GetIndexer())
}
...
type aPIServiceNamespaceInformer struct {
	...
	lister   kubebindv1alpha1.APIServiceNamespaceLister
}
...
func (i *aPIServiceNamespaceInformer) Lister() kubebindv1alpha1.APIServiceNamespaceLister {
	return i.lister
}
...
func (i *aPIServiceNamespaceScopedInformer) Lister() kubebindv1alpha1.APIServiceNamespaceLister {
	return kubebindv1alpha1.NewAPIServiceNamespaceLister(i.Informer().GetIndexer())
}
