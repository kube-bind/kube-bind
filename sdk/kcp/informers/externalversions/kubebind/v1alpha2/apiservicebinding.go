...
type APIServiceBindingClusterInformer interface {
	...
	Lister() kubebindv1alpha2.APIServiceBindingClusterLister
}
	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubeBindV1alpha2().APIServiceBindings().List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubeBindV1alpha2().APIServiceBindings().Watch(context.Background(), options)
			},
		},
		&apiskubebindv1alpha2.APIServiceBinding{},
		resyncPeriod,
		indexers,
	)
}
...
func (i *aPIServiceBindingClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apiskubebindv1alpha2.APIServiceBinding{}, i.defaultInformer)
}

func (i *aPIServiceBindingClusterInformer) Lister() kubebindv1alpha2.APIServiceBindingClusterLister {
	return kubebindv1alpha2.NewAPIServiceBindingClusterLister(i.Informer().GetIndexer())
}
...
type aPIServiceBindingInformer struct {
	...
	lister   kubebindv1alpha2.APIServiceBindingLister
}
...
func (i *aPIServiceBindingInformer) Lister() kubebindv1alpha2.APIServiceBindingLister {
	return i.lister
}
...
func (i *aPIServiceBindingScopedInformer) Lister() kubebindv1alpha2.APIServiceBindingLister {
	return kubebindv1alpha2.NewAPIServiceBindingLister(i.Informer().GetIndexer())
}
