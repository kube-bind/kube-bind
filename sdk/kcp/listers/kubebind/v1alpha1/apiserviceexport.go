...
type aPIServiceExportClusterLister struct {
	kcplisters.ResourceClusterIndexer[*kubebindv1alpha1.APIServiceExport]
}
...
func NewAPIServiceExportClusterLister(indexer cache.Indexer) APIServiceExportClusterLister {
	return &aPIServiceExportClusterLister{
		kcplisters.NewCluster[*kubebindv1alpha1.APIServiceExport](indexer, kubebindv1alpha1.Resource("apiserviceexport")),
	}
}
...
type aPIServiceExportLister struct {
	kcplisters.ResourceIndexer[*kubebindv1alpha1.APIServiceExport]
}
...
func NewAPIServiceExportLister(indexer cache.Indexer) APIServiceExportLister {
	return &aPIServiceExportLister{
		kcplisters.New[*kubebindv1alpha1.APIServiceExport](indexer, kubebindv1alpha1.Resource("apiserviceexport")),
	}
}
