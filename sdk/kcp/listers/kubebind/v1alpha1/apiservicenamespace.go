...
type aPIServiceNamespaceClusterLister struct {
	kcplisters.ResourceClusterIndexer[*kubebindv1alpha1.APIServiceNamespace]
}
...
func NewAPIServiceNamespaceClusterLister(indexer cache.Indexer) APIServiceNamespaceClusterLister {
	return &aPIServiceNamespaceClusterLister{
		kcplisters.NewCluster[*kubebindv1alpha1.APIServiceNamespace](indexer, kubebindv1alpha1.Resource("apiservicenamespace")),
	}
}
...
type aPIServiceNamespaceLister struct {
	kcplisters.ResourceIndexer[*kubebindv1alpha1.APIServiceNamespace]
}
...
func NewAPIServiceNamespaceLister(indexer cache.Indexer) APIServiceNamespaceLister {
	return &aPIServiceNamespaceLister{
		kcplisters.New[*kubebindv1alpha1.APIServiceNamespace](indexer, kubebindv1alpha1.Resource("apiservicenamespace")),
	}
}
