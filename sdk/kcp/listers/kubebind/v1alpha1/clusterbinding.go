...
type clusterBindingClusterLister struct {
	kcplisters.ResourceClusterIndexer[*kubebindv1alpha1.ClusterBinding]
}
...
func NewClusterBindingClusterLister(indexer cache.Indexer) ClusterBindingClusterLister {
	return &clusterBindingClusterLister{
		kcplisters.NewCluster[*kubebindv1alpha1.ClusterBinding](indexer, kubebindv1alpha1.Resource("clusterbinding")),
	}
}
...
type clusterBindingLister struct {
	kcplisters.ResourceIndexer[*kubebindv1alpha1.ClusterBinding]
}
...
func NewClusterBindingLister(indexer cache.Indexer) ClusterBindingLister {
	return &clusterBindingLister{
		kcplisters.New[*kubebindv1alpha1.ClusterBinding](indexer, kubebindv1alpha1.Resource("clusterbinding")),
	}
}
