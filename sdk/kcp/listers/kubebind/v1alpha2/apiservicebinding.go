...
type aPIServiceBindingClusterLister struct {
	kcplisters.ResourceClusterIndexer[*kubebindv1alpha2.APIServiceBinding]
}
...
func NewAPIServiceBindingClusterLister(indexer cache.Indexer) APIServiceBindingClusterLister {
	return &aPIServiceBindingClusterLister{
		kcplisters.NewCluster[*kubebindv1alpha2.APIServiceBinding](indexer, kubebindv1alpha2.Resource("apiservicebinding")),
	}
}
...
type aPIServiceBindingLister struct {
	kcplisters.ResourceIndexer[*kubebindv1alpha2.APIServiceBinding]
}
...
func NewAPIServiceBindingLister(indexer cache.Indexer) APIServiceBindingLister {
	return &aPIServiceBindingLister{
		kcplisters.New[*kubebindv1alpha2.APIServiceBinding](indexer, kubebindv1alpha2.Resource("apiservicebinding")),
	}
}
