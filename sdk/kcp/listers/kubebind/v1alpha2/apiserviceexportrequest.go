...
type aPIServiceExportRequestClusterLister struct {
	kcplisters.ResourceClusterIndexer[*kubebindv1alpha2.APIServiceExportRequest]
}
...
func NewAPIServiceExportRequestClusterLister(indexer cache.Indexer) APIServiceExportRequestClusterLister {
	return &aPIServiceExportRequestClusterLister{
		kcplisters.NewCluster[*kubebindv1alpha2.APIServiceExportRequest](indexer, kubebindv1alpha2.Resource("apiserviceexportrequest")),
	}
}
...
type aPIServiceExportRequestLister struct {
	kcplisters.ResourceIndexer[*kubebindv1alpha2.APIServiceExportRequest]
}
...
func NewAPIServiceExportRequestLister(indexer cache.Indexer) APIServiceExportRequestLister {
	return &aPIServiceExportRequestLister{
		kcplisters.New[*kubebindv1alpha2.APIServiceExportRequest](indexer, kubebindv1alpha2.Resource("apiserviceexportrequest")),
	}
}
