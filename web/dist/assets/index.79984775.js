...
var require_index_001 = __commonJS({
  "assets/index.79984775.js"(exports) {
    (function polyfill() {
    ...
    **/
    ...
    class AuthService {
        ...
        return __async$4(this, null, function* () {
          ...
          try {
            ...
            if (((_a = error == null ? void 0 : error.response) == null ? void 0 : _a.status) === 401 || ((_b = error == null ? void 0 : error.response) == null ? void 0 : _b.status) === 403) {
              console.log(
                "Auth check failed with authentication error but no structured response"
              );
              return {
                isAuthenticated: false,
      ...
      initiateAuth(sessionId, clusterId, consumerId) {
        return __async$4(this, null, function* () {
          ...
          sessionStorage.setItem(
            ...
            JSON.stringify(paramsToPreserve)
          );
      ...
      isCliFlow() {
        ...
        const preservedParams = sessionStorage.getItem(
          PRESERVED_PARAMS_STORAGE_KEY
        );
        if (preservedParams) {
          try {
      ...
      restorePreservedParams() {
        const preservedParamsJson = sessionStorage.getItem(
          PRESERVED_PARAMS_STORAGE_KEY
        );
          ...
          return openBlock(), createElementBlock("div", _hoisted_1$4, [
            createBaseVNode("header", _hoisted_2$4, [
              createBaseVNode("div", _hoisted_3$4, [
                _cache[2] || (_cache[2] = createStaticVNode('<div class="brand" data-v-0b535f4a><div class="logo" data-v-0b535f4a><svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-0b535f4a><path d="M12 2L2 7L12 12L22 7L12 2Z" stroke="currentColor" stroke-width="2" stroke-linejoin="round" data-v-0b535f4a></path><path d="M2 17L12 22L22 17" stroke="currentColor" stroke-width="2" stroke-linejoin="round" data-v-0b535f4a></path><path d="M2 12L12 17L22 12" stroke="currentColor" stroke-width="2" stroke-linejoin="round" data-v-0b535f4a></path></svg></div><h1 data-v-0b535f4a>Kube Bind</h1></div>', 1)),
    ...
    const App_vue_vue_type_style_index_0_scoped_0b535f4a_lang = "";
    ...
    const App = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-0b535f4a"]]);
    ...
    const _hoisted_3$3 = { class: "method-tabs" };
    const _hoisted_4$3 = {
      key: 0,
      class: "instructions-section"
    };
    const _hoisted_5$3 = { class: "step-group" };
    const _hoisted_6$3 = { class: "command-block" };
    const _hoisted_7$3 = { class: "step-group" };
    const _hoisted_8$2 = { class: "command-block" };
    const _hoisted_9$2 = { class: "step-group" };
    const _hoisted_10$2 = { class: "command-block" };
    const _hoisted_11$2 = {
      key: 1,
      class: "instructions-section"
    };
    const _hoisted_12$2 = { class: "step-group" };
    const _hoisted_13$2 = { class: "command-block" };
    const _hoisted_14$2 = { class: "step-group" };
    const _hoisted_15$2 = { class: "command-block" };
    const _hoisted_16$2 = { class: "step-group" };
    const _hoisted_17$2 = { class: "command-block" };
...
`;
        ...
        const downloadKonnectorManifests = () => __async$2(this, null, function* () {
          try {
          ...
          return _ctx.show ? (openBlock(), createElementBlock("div", {
            ...
            createBaseVNode("div", {
              ...
              createBaseVNode("div", { class: "binding-header" }, [
                _cache[9] || (_cache[9] = createBaseVNode("h3", null, "Template Binding Successful", -1)),
                createBaseVNode("button", {
                  onClick: closeModal,
                  class: "close-btn"
                }, "×")
              ...
              createBaseVNode("div", _hoisted_1$3, [
                createBaseVNode("div", _hoisted_2$3, [
                  ...
                  createBaseVNode("p", null, [
                    _cache[10] || (_cache[10] = createBaseVNode("strong", null, "Template:", -1)),
                    createTextVNode(" " + toDisplayString(_ctx.templateName), 1)
                  ]),
                  createBaseVNode("p", null, [
                    _cache[11] || (_cache[11] = createBaseVNode("strong", null, "Binding Name:", -1)),
                ...
                activeMethod.value === "bundle" ? (openBlock(), createElementBlock("div", _hoisted_4$3, [
                  ...
                  createBaseVNode("div", _hoisted_5$3, [
                    ...
                    createBaseVNode("div", _hoisted_6$3, [
                      _cache[13] || (_cache[13] = createBaseVNode("code", null, "kubectl apply -f konnector.yaml", -1)),
                      createBaseVNode("button", {
                  ...
                  createBaseVNode("div", _hoisted_7$3, [
                    ...
                    createBaseVNode("div", _hoisted_8$2, [
                      _cache[16] || (_cache[16] = createBaseVNode("code", null, "kubectl apply -f binding-bundle.yaml", -1)),
                      createBaseVNode("button", {
                  ...
                  createBaseVNode("div", _hoisted_9$2, [
                    _cache[20] || (_cache[20] = createBaseVNode("h5", null, "3. Verify", -1)),
                    createBaseVNode("div", _hoisted_10$2, [
                      _cache[19] || (_cache[19] = createBaseVNode("code", null, "kubectl get apiservicebindingbundles,apiservicebindings", -1)),
                      createBaseVNode("button", {
                ...
                activeMethod.value === "manual" ? (openBlock(), createElementBlock("div", _hoisted_11$2, [
                  ...
                  createBaseVNode("div", { class: "step-group" }, [
                    _cache[22] || (_cache[22] = createBaseVNode("h5", null, "1. Download required files", -1)),
                    createBaseVNode("div", { class: "download-block" }, [
                      createBaseVNode("div", { class: "download-actions" }, [
                        createBaseVNode("button", {
                  ...
                  createBaseVNode("div", _hoisted_12$2, [
                    _cache[24] || (_cache[24] = createBaseVNode("h5", null, "2. Create kube-bind namespace", -1)),
                    createBaseVNode("div", _hoisted_13$2, [
                      _cache[23] || (_cache[23] = createBaseVNode("code", null, "kubectl create namespace kube-bind --dry-run=client -o yaml | kubectl apply -f -", -1)),
                      createBaseVNode("button", {
                  ...
                  createBaseVNode("div", _hoisted_14$2, [
                    _cache[25] || (_cache[25] = createBaseVNode("h5", null, "3. Create kubeconfig secret", -1)),
                  ...
                  createBaseVNode("div", _hoisted_16$2, [
                    _cache[26] || (_cache[26] = createBaseVNode("h5", null, "4. Bind the API service", -1)),
    ...
    const BindingResult_vue_vue_type_style_index_0_scoped_c11e5fbb_lang = "";
    const BindingResult = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-c11e5fbb"]]);
...
Details: ${kubeError.details || "No additional details available"}`;
    ...
    const Resources_vue_vue_type_style_index_0_scoped_2bef16ba_lang = "";
    const Resources = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2bef16ba"]]);
    const routes = [
